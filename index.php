...
<body>
    ...
    <div class="container ">
        ...
        <div class="row">
            <div class="top_content col-md-5 col-sm-7  col-lg-5  ">
                <p class="mb-5">Empowering transportation solutions for a connected world.</p><button class="btn btn-warning  rounded-pill btn1 m-2">Contact Us</button><button class="btn btn-outline-warning rounded-pill m-2">Learn More</button>
            </div>
            <div class="col-md-7 top_ride"> <img class="img-fluid" src="assets/images/top_ride.png" alt=""></div>
        </div>
    </div>

    <div class="container-fluid ride_card">
                ...
                <div class="col-md-4 ">
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body d-flex justify-content-between flex-column  text-light">
                            ...
                            <a href="services.php" class="align-self-end"><img style="height:50px" src="assets/images/arrow.png" alt=""></a>
    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center ">
            ...
            <div class="col-md-6 col-sm-7  col-lg-7 drive-value">
                ...
                <p >Go live in as little as 3 days. We’re designed for speed, no matter your mode of operation.</p>
            </div>
    ...
    <footer class="bd-footer px-4 mt-5 bg-light py-0">
